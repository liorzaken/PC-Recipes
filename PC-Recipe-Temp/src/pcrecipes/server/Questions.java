...
public class Questions {
	...
	public String[] inputAnswer(){
		...
		answersArray[37] = "מתאים לרגישים ללקטוז";
		answersArray[38] = "מתאים לרגישים לגלוטן";
		answersArray[39] = "מתאים לרגישים לסוכר";
		answersArray[40] = "G6PD-מתאים לרגישים ל";
		answersArray[41] = "לא כשר"; // כן-רוצה לבשל עם מצרכים לא כשרים
		answersArray[42] = "כשר"; // לא- לא רוצה לבשל עם מצרכים לא כשרים
